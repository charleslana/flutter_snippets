...
class SnippetCalculator extends StatefulWidget {
  const SnippetCalculator({Key? key}) : super(key: key);

  @override
  _SnippetCalculatorState createState() => _SnippetCalculatorState();
}

class _SnippetCalculatorState extends State<SnippetCalculator> {
  String num1 = '0';
  String num2 = '0';
  String answerText = '0';
  double answer = 0;
