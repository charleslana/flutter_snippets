...
class SnippetStepper extends StatefulWidget {
  const SnippetStepper({Key? key}) : super(key: key);
  ...
  void _goToPage() {
    ...
    Navigator.push(
      ...
      MaterialPageRoute<dynamic>(
          builder: (context) => const SnippetStepperMyAppMaterialPage()),
    );
  }
...
class SnippetStepperMyAppMaterialPage extends StatelessWidget {
  const SnippetStepperMyAppMaterialPage({Key? key}) : super(key: key);
